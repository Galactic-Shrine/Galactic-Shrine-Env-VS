...
namespace GalacticShrine {
  ...
  public class DossierReference: FichierSystemeReference, IEquatable<DossierReference> {
     ...
     * </param>
     **/
    public static void Creer(DossierReference Localisation) => Directory.CreateDirectory(Localisation.NomComplet);
     ...
     * </retruns>
     **/
    public static bool VerifieSiExiste(DossierReference Localisation) => Directory.Exists(Localisation.NomComplet);
